...
# to JSON
is( to_myjson({a=>bson_time(0)}), q[{"a":{"$date":"1970-01-01T00:00:00Z"}}], 'json: bson_time(0)' );
is( to_myjson({a=>BSON::Time->new(value => "1356351330500")}), q[{"a":{"$date":"2012-12-24T12:15:30.500Z"}}], 'json: bson_time(1356351330.5)' );
